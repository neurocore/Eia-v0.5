...
struct MovePicker
{
  ...
  Move get_next(bool do_quiets = true);
};
...
template<> Move MovePickerPVS::get_next(bool do_quiets);
template<> Move MovePickerQS::get_next(bool do_quiets);
